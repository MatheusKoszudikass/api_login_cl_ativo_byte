...
class getSecurity_AccessMapService extends App_KernelProdContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).''.\DIRECTORY_SEPARATOR.'vendor'.\DIRECTORY_SEPARATOR.'symfony'.\DIRECTORY_SEPARATOR.'http-foundation'.\DIRECTORY_SEPARATOR.'RequestMatcher'.\DIRECTORY_SEPARATOR.'PortRequestMatcher.php';

        $container->privates['security.access_map'] = $instance = new \Symfony\Component\Security\Http\AccessMap();

        $instance->add(new \Symfony\Component\HttpFoundation\ChainRequestMatcher([new \Symfony\Component\HttpFoundation\RequestMatcher\PathRequestMatcher('^/api'), new \Symfony\Component\HttpFoundation\RequestMatcher\IpsRequestMatcher(['192.168.0.1']), new \Symfony\Component\HttpFoundation\RequestMatcher\PortRequestMatcher(443)]), ['IS_AUTHENTICATED_ANONYMOUSLY && !IS_AUTHENTICATED_FULLY'], NULL);
