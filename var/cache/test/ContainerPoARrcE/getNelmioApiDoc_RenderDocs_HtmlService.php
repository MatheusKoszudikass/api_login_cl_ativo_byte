...
class getNelmioApiDoc_RenderDocs_HtmlService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['nelmio_api_doc.render_docs.html'] = new \Nelmio\ApiDocBundle\Render\Html\HtmlOpenApiRenderer(($container->privates['twig'] ?? $container->load('getTwigService')), ['assets_mode' => 'cdn', 'swagger_ui_config' => [], 'redocly_config' => []]);
    }
}
