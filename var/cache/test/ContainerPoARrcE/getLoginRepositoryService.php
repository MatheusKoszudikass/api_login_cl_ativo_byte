...
class getLoginRepositoryService extends App_KernelTestDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        return $container->privates['App\\Repository\\LoginRepository'] = new \App\Repository\LoginRepository(($container->services['doctrine'] ?? self::getDoctrineService($container)), ($container->privates['App\\Service\\MapperService'] ??= new \App\Service\MapperService()), ($container->privates['App\\Service\\EmailService'] ??= new \App\Service\EmailService()), ($container->privates['App\\Service\\TwoFactorAuthService'] ?? $container->load('getTwoFactorAuthServiceService')), ($container->privates['App\\Repository\\UserRepository'] ?? $container->load('getUserRepositoryService')), ($container->privates['App\\Service\\MapperServiceResponse'] ??= new \App\Service\MapperServiceResponse()));
    }
}
