...
class App_KernelTestDebugContainer extends Container
{
    ...
    {
        $container->services['doctrine.dbal.default_connection'] = $instance = ($container->privates['doctrine.dbal.connection_factory'] ?? self::getDoctrine_Dbal_ConnectionFactoryService($container))->createConnection(['url' => $container->getEnv('resolve:DATABASE_URL'), 'driver' => 'pdo_sqlite', 'use_savepoints' => true, 'dbname_suffix' => '_test'.$container->getEnv('string:default::TEST_TOKEN'), 'idle_connection_ttl' => 600, 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => NULL, 'driverOptions' => [], 'defaultTableOptions' => [], 'dama.connection_key' => 'default'], ($container->privates['doctrine.dbal.default_connection.configuration'] ?? self::getDoctrine_Dbal_DefaultConnection_ConfigurationService($container)), ($container->privates['doctrine.dbal.default_connection.event_manager'] ?? self::getDoctrine_Dbal_DefaultConnection_EventManagerService($container)), []);
    ...
    protected static function getDebug_ControllerResolver_InnerService($container)
    {
        ...
        $instance->allowControllers(['App\\Kernel', 'App\\Controller\\LoginController', 'App\\Controller\\RoleController', 'App\\Controller\\UserController', 'Doctrine\\Bundle\\DoctrineBundle\\Controller\\ProfilerController']);
    ...
    protected static function getDoctrine_Dbal_DefaultConnection_ConfigurationService($container)
    {
        ...
        $instance->setMiddlewares([2 => ($container->privates['dama.doctrine.dbal.middleware.default.default'] ??= new \DAMA\DoctrineTestBundle\Doctrine\DBAL\Middleware()), 0 => ($container->privates['doctrine.dbal.debug_middleware.default'] ?? self::getDoctrine_Dbal_DebugMiddleware_DefaultService($container)), 1 => ($container->privates['doctrine.dbal.idle_connection_middleware.default'] ?? self::getDoctrine_Dbal_IdleConnectionMiddleware_DefaultService($container))]);
    ...
    {
        return $container->privates['doctrine.debug_data_holder'] = new \Doctrine\Bundle\DoctrineBundle\Middleware\BacktraceDebugDataHolder($container->parameters['nelmio_api_doc.areas']);
    }
