 ...
 */
class getNelmioApiDoc_ObjectModel_PropertyDescribers_CompoundService extends App_KernelTestDebugContainer
{
    /**
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        include_once \dirname(__DIR__, 4).'/vendor/nelmio/api-doc-bundle/src/PropertyDescriber/CompoundPropertyDescriber.php';
